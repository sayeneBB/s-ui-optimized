...
### Windows
1. 从 [GitHub Releases](https://github.com/sayeneBB/s-ui-optimized/releases/latest) 下载最新 Windows 版本。
2. 解压 ZIP 文件。
...
### Linux/macOS
1. 根据你的系统和架构，从 GitHub 获取最新版本 S-UI：[https://github.com/sayeneBB/s-ui-optimized/releases/latest](https://github.com/sayeneBB/s-ui-optimized/releases/latest)
2. **可选：** 获取最新版 `s-ui.sh`：[https://raw.githubusercontent.com/sayeneBB/s-ui-optimized/main/s-ui.sh](https://raw.githubusercontent.com/sayeneBB/s-ui-optimized/main/s-ui.sh)
...
### Windows
1. 从 GitHub 获取最新 Windows 版本：[https://github.com/sayeneBB/s-ui-optimized/releases/latest](https://github.com/sayeneBB/s-ui-optimized/releases/latest)
...
services:
  s-ui:
    image: ghcr.io/sayeneBB/s-ui-optimized
    container_name: s-ui
    hostname: "s-ui"
    network_mode: host
    volumes:
...
docker run -itd \
    ...
    --name s-ui \
    --restart=unless-stopped \
    ghcr.io/sayeneBB/s-ui-optimized
```

> 自行构建镜像

```shell
git clone https://github.com/sayeneBB/s-ui-optimized
docker build -t s-ui .
```
